...
<html>
  <head>
    ...
    <title>SMA NEGERI 1 SELESAI</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" id="scrollspy">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">SMA NEGERI 1 SELESAI</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li>
							<a href="mahasiswa.php"><span class="glyphicon glyphicon-hand-down"></span> Siswa</a>
						</li>
						<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-tasks"></span> Jurusan <span class="caret"></span>
							...
							<ul class="dropdown-menu">
								<li><a href="informatika.php">Ilmu Pengetahuan Alam</a><
								<li><a href="manajemen-informatika.php">Ilmu Pengetahuan Sosial</a></li>
